...
* [Web hacking](web/web-hacking.md)
...
* [Brute force directories and files](tools/brute-force-directories-and-files.md)
* [Dirb](tools/dirb.md)
...
* [The Bash Environment](linux/the-bash-environment.md)

## Windows

* [Hack with Powershell](windows/hack-with-powershell.md)
